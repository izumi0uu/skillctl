...
#
# Parity target: scripts/bootstrap-reverse.ps1
...
#
# Usage:
#   bash scripts/bootstrap-reverse.sh <capability1> [capability2] ... [--start-services] [--skip-refresh]
...
Examples:
  bash scripts/bootstrap-reverse.sh jadx apktool frida
  bash scripts/bootstrap-reverse.sh jshookmcp anything-analyzer
  bash scripts/bootstrap-reverse.sh idapro --start-services
  bash scripts/bootstrap-reverse.sh burpsuite-mcp
