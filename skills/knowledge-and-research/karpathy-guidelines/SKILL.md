...
description: Behavioral guidelines to reduce common LLM coding mistakes. Use only when the user explicitly invokes `$karpathy-guidelines`, says to use the `karpathy-guidelines` skill, or directly asks for Karpathy guidelines. Do not auto-activate for general coding, review, or refactoring tasks.
license: MIT
---
