...
| ego-browser-guard | Agent Infra | local-authored | n/a | n/a | n/a | n/a | no |
...
| generate-images-via-relay | Productivity And Artifacts | local-authored | n/a | n/a | n/a | n/a | no |
...
| humanizer | Knowledge And Research | imported-upstream | [blader/humanizer](https://github.com/blader/humanizer) | [.](https://github.com/blader/humanizer) | 523374dee72d67c7b2b5f858ea0094ffda49c3ac | [open](https://github.com/blader/humanizer) | no |
| humanizer-zh | Knowledge And Research | imported-upstream | [op7418/Humanizer-zh](https://github.com/op7418/Humanizer-zh) | [.](https://github.com/op7418/Humanizer-zh) | 91f3d394db8419c20d67ebe22a96cf8fee0a404b | [open](https://github.com/op7418/Humanizer-zh) | no |
...
| personal-xbar | Agent Infra | local-authored | n/a | n/a | n/a | n/a | no |
...
| trellis-design-doc-generator | Productivity And Artifacts | local-authored | n/a | n/a | n/a | n/a | no |
| trellis-lite | Agent Infra | local-authored | n/a | n/a | n/a | n/a | no |
| trellis-task-reuse | Agent Infra | local-authored | n/a | n/a | n/a | n/a | no |
...
| writing-for-agents | Productivity And Artifacts | derived-from-upstream | [mattpocock/skills](https://github.com/mattpocock/skills/tree/84fdeffd12f2ee307994d1eb6feb48173b6e0502/skills/productivity/writing-for-agents) | [skills/productivity/writing-for-agents](https://github.com/mattpocock/skills/tree/84fdeffd12f2ee307994d1eb6feb48173b6e0502/skills/productivity/writing-for-agents) | 84fdeffd12f2ee307994d1eb6feb48173b6e0502 | [open](https://github.com/mattpocock/skills/tree/84fdeffd12f2ee307994d1eb6feb48173b6e0502/skills/productivity/writing-for-agents) | yes |
...
| --- | --- | --- |
| Agent Infra | Agent runtime, configuration, recovery, and operational control-plane skills | `anyrouter-config`, `codex-config-health`, `codex-session-recovery`, `dap-handoff-writer`, `ego-browser-guard`, `find-skills`, `hermes-issue-triage`, `hermes-upstream-worktree-fix`, `personal-xbar`, `rename-codex-sessions`, `skillctl-control-plane`, `thread-memory-capsule`, `trellis-lite`, `trellis-task-reuse`, `watch-hot-node` |
| Knowledge And Research | Knowledge workflows, learning systems, and reusable research guidance | `adhd`, `agents-best-practices`, `grill-me`, `grill-with-docs`, `hermes-pr-notion-notes`, `humanizer`, `humanizer-zh`, `js-reverse`, `karpathy-guidelines`, `obsidian-llm-wiki`, `writing-guidelines` |
